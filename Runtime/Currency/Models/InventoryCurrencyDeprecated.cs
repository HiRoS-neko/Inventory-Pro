...
namespace Devdog.InventoryPro
{
    ...
    public class InventoryCurrencyDeprecated
    {
        public uint ID;
        ...
        {
            get { return ItemManager.database.currencies.FirstOrDefault(o => o.ID == autoConvertOnMaxCurrencyID); }
        }
