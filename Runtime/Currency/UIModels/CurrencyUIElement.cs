...
namespace Devdog.InventoryPro
{
    ...
    public struct CurrencyUIElement
    {
        ...
        public void Repaint(CurrencyDecorator decorator)
        {
            ...
            if (_amount != null)
            {
                if (decorator.amount <= 0f && _hideWhenEmpty) _amount.gameObject.SetActive(false);
            ...
            if (_icon != null)
            {
                if (decorator.amount <= 0f && _hideWhenEmpty) _icon.gameObject.SetActive(false);
        ...
        public void Reset()
        {
            ...
            if (_hideWhenEmpty) SetActive(false);
        }
