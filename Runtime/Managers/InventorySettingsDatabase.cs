...
namespace Devdog.InventoryPro
{
    ...
    public class InventorySettingsDatabase : ScriptableObject
    {
        ...
        public InventoryActionInput unstackKeys = new(PointerEventData.InputButton.Right,
            InventoryActionInput.EventType.OnPointerUp, KeyCode.LeftShift);

        /// <summary>
        ///     The keys used to "use" an item.
        /// </summary>
        public InventoryActionInput useItemKeys = new(PointerEventData.InputButton.Right,
            InventoryActionInput.EventType.OnPointerUp, KeyCode.None);

        /// <summary>
        ///     Trigger the context menu using, the following button
        /// </summary>
        public InventoryActionInput triggerContextMenuKeys = new(PointerEventData.InputButton.Left,
            InventoryActionInput.EventType.OnPointerUp, KeyCode.None);
