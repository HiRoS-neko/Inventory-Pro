...
namespace Devdog.InventoryPro
{
    ...
    public class ItemDatabase : ScriptableObject
    {
        ...
        {
            get { return currencies.Select(o => o.pluralName).ToArray(); }
        }

        public string[] singleCurrenciesStrings
        {
            get { return currencies.Select(o => o.singleName).ToArray(); }
        }

        public string[] craftingCategoriesStrings
        {
            get { return craftingCategories.Select(o => o.name).ToArray(); }
        }

        public string[] propertiesStrings
        {
            get { return statDefinitions.Select(o => o.statName).ToArray(); }
        }

        public string[] rarityStrings
        {
            get { return rarities.Select(o => o.name).ToArray(); }
        }

        public Color[] itemRaritiesColors
        {
            get { return rarities.Select(o => o.color).ToArray(); }
        }

        public string[] itemCategoriesStrings
        {
            get { return categories.Select(o => o.name).ToArray(); }
        }

        public string[] equipmentTypesStrings
        {
            get { return equipmentTypes.Select(o => o.name).ToArray(); }
        }
...
#pragma warning disable 618
        ...
        public InventoryCraftingCategoryDeprecated[] inventoryCraftingCategories =
            new InventoryCraftingCategoryDeprecated[0];
