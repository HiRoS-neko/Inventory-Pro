...
namespace Devdog.InventoryPro
{
    ...
    public class ItemFilter
    {
        ...
        public Type typeValue => Type.GetType(stringValue);
        ...
        public bool VerifyFilter(InventoryItemBase item, Type type, FilterType filterType)
        {
        ...
        {
            var equality = VerifyFilterEqualNotEqual(a, b, filterType);
            if (equality)
                return equality;
