...
namespace Devdog.InventoryPro
{
    ...
    public partial class InventoryContextMenu : MonoBehaviour
    {
        ...
        private readonly List<ContextMenuOption> _menuOptions = new(8);
        ...
        public virtual void Update()
        {
            ...
            if (Input.GetKeyUp(KeyCode.Mouse0) && closeWindowWhenClickedOutside &&
                Vector2.Distance(Input.mousePosition, transform.position) > 50f)
                if (InventoryUIUtility.currentlyHoveringSlot == null ||
                    InventoryUIUtility.currentlyHoveringSlot.item == null)
                    window.Hide();
        }
        ...
        private void window_OnWindowShow()
        {
            ...
            if (_menuOptions.Count > 0) _menuOptions[0].uiElement.button.Select();
        }
        ...
        public virtual void ClearMenuOptions()
        {
            ...
            // Remove the old
            foreach (var item in _menuOptions) _pool.Destroy(item.uiElement);
        ...
        /// </summary>
        public class ContextMenuOption : ItemUsability
        {
            public InventoryContextMenuRowUI uiElement;

            public ContextMenuOption(string actionName, Action<InventoryItemBase> useItemCallback,
                InventoryContextMenuRowUI uiElement)
