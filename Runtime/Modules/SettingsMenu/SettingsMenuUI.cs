...
namespace Devdog.InventoryPro
{
    ...
    {
        /// <summary>
        ///     When true, each time the "keyCode" is pressed a window is hidden. When there are no longer any interactive windows
        ///     visible the settings menu will be shown.
        ...
        [NonSerialized]
        private readonly List<UIWindow> _hiddenWindows = new();
        ...
        {
            if (restoreWindowsAfterClose) RestoreInteractiveWindows();
        }
