...
namespace Devdog.InventoryPro
{
    ...
    public class InventoryCraftingBlueprintDeprecated
    {
        /// <summary>
...
//        public int indexInCategory;
        ...
        public bool overrideCategoryAudioClips;
...
/// </summary>
public float craftingTimeDuration;
...
public string name
        {
            get
            {
                ...
                {
                    if (resultItems.Length == 0) return string.Empty;
