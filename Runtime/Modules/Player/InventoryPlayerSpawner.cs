    ...
    public class InventoryPlayerSpawner : InventoryPlayerBase
    {
        ...
        public virtual void Spawn()
        {
            ...
            if (forceSingleCharacter && foundPlayer != null)
            {
                ...
                if (foundPlayer.isInitialized == false) foundPlayer.Init();

                if (movePlayerToSpawnPosition) foundPlayer.transform.position = transform.position;
                return;
            }
            ...
            if (dontDestroyPlayerOnLoad) DontDestroyOnLoad(playerObj);
            ...
            {
                player.characterUI = characterUI;
                player.inventoryCollections = inventoryCollections;
                player.skillbarCollection = skillbarCollection;
            }

            if (overrideEquipmentBinders) player.equipmentBinders = equipmentBinders;
