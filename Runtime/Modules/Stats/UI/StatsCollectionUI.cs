...
namespace Devdog.InventoryPro.UI
{
    ...
    /// </summary>
    public class StatsCollectionUI : MonoBehaviour
    {
        [Required]
        ...
        private readonly Dictionary<IStat, StatRowUI> _uiLookup = new();
        private UIWindow _window;

        public StatsCollection statsCollection
        {
            get => _statsCollection;
            set
            {
        ...
        {
            if (_window != null) _window.OnShow += OnWindowShown;
        }
        ...
        {
            var inst = Instantiate(stat.definition.uiPrefab ?? defaultStatusRowPrefab);
            _uiLookup[stat] = inst;
            return inst;
        }
        ...
        {
            return Instantiate(statusCategoryPrefab);
        }
        ...
        {
            if (isActiveAndEnabled == false || defaultStatusRowPrefab == null) return;
