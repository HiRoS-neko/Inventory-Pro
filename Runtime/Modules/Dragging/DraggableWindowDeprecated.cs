...
namespace Devdog.InventoryPro.UI
{
    ...
    public class DraggableWindowDeprecated : MonoBehaviour, IBeginDragHandler, IDragHandler, IPointerDownHandler
    {
        [Header("Dragging")]
        ...
        public Vector2 spacing = new(100.0f, 100.0f);
        ...
        public void OnDrag(PointerEventData eventData)
        {
            ...
            if (preventFromGoingOutOfBounds) _rectTransform.position = Clamp(_rectTransform.position, _minPos, _maxPos);
        }
