...
namespace Devdog.InventoryPro.UI
{
    ...
    public class DraggingOutline : MonoBehaviour
    {
        ...
        protected virtual void InventoryUiDragUtilityOnOnStartDragging(UIDragModel dragModel,
            ItemCollectionSlotUIBase dragging, PointerEventData eventData)
        {
        ...
        protected virtual void InventoryUiDragUtilityOnOnEndDragging(UIDragModel dragModel,
            ItemCollectionSlotUIBase dragging, PointerEventData eventData)
        {
            RemoveOutlineValues();
        }
