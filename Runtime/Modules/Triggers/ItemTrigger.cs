...
namespace Devdog.InventoryPro
{
    public class ItemTrigger : TriggerBase
    {
        ...
        {
            if (itemPrefab != null && _itemToAddToInventory != null) Destroy(_itemToAddToInventory.gameObject);
            ...
            {
                _itemToAddToInventory = Instantiate(itemPrefab);
        ...
        public override bool CanUse(Player player)
        {
            ...
            if (_itemToAddToInventory == null) return false;
        ...
        public override bool Use(Player player)
        {
            ...
            if (CanUse(player) == false)
            {
                if (_itemToAddToInventory != null && InventoryManager.CanAddItem(_itemToAddToInventory) == false)
                    InventoryManager.langDatabase.collectionFull.Show(_itemToAddToInventory.name,
                        _itemToAddToInventory.description, "Inventory");
            ...
            if (itemPrefab != null) Destroy(gameObject);
