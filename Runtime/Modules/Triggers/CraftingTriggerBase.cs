...
#pragma warning disable 0067 // Events are considered unused by Unity, even though they are...
...
namespace Devdog.InventoryPro
{
    ...
    public abstract class CraftingTriggerBase<T> : MonoBehaviour, ICraftingActionValidator, ITriggerCallbacks
        where T : CraftingWindowBase
    {
        [SerializeField]
        [Required]
        ...
        public bool removeItemsOnCraftStart;
        ...
        {
            get => _craftingCategory;
            set => _craftingCategory = value;
        }

        public string uniqueName => _uniqueName;

        public static CraftingProgressSharingDataStructure<CraftingProgressContainer> progressContainerDataStructure
        {
            get;
            set;
        }
        ...
        protected virtual void Awake()
        {
            ...
            if (progressContainerDataStructure == null)
                progressContainerDataStructure =
                    new CraftingProgressSharingDataStructure<CraftingProgressContainer>(CreateNewProgressContainer,
                        CreateNewProgressContainer(this, GetInstanceID()));

            progressContainer = progressContainerDataStructure.Get(this, GetInstanceID(),
                craftingCategory.ID + GetType().GetHashCode(), _progressShareSetting);
            ...
            {
                Debug.LogWarning(
                    "Crafting trigger created but no CraftingStandardUI found in scene, or not set in managers.",
                    transform);
            }
        }
        ...
        private void NotifyOnCraftStart(CraftingProgressContainer.CraftInfo craftInfo)
        {
            ...
            Debug.Log("On craft start on " + gameObject.name + " validator : " + craftInfo.validator.gameObject.name,
                gameObject);
        ...
        {
            craftingWindow.UseWithTrigger(craftInfo.category, progressContainer, this, craftingItemsCollection,
                craftingRewardItemsCollection);
        }
        ...
        public virtual bool OnTriggerUsed(Player player)
        {
            ...
            craftingWindow.UseWithTrigger(craftingCategory, progressContainer, this, craftingItemsCollection,
                craftingRewardItemsCollection);
        ...
        private void RegisterEvents()
        {
            ...
            if (craftingWindow.storeRewardUIItemsInCollection != null)
                craftingWindow.storeRewardUIItemsInCollection.OnRemovedItem +=
                    StoreRewardUIItemsInCollectionOnOnRemovedItem;

            if (craftingRewardItemsCollection != null)
                craftingRewardItemsCollection.OnSetItem += SetItemInUIRewardsCollection;
        }

        private void StoreRewardUIItemsInCollectionOnOnRemovedItem(InventoryItemBase item, uint itemID, uint slot,
            uint amount)
        {
            if (craftingRewardItemsCollection != null)
            {
