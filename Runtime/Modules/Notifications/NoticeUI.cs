...
namespace Devdog.InventoryPro
{
    ...
    public class NoticeUI : MonoBehaviour
    {
        ...
        public AudioClipInfo onNewMessageAudioClip;
        ...
        [NonSerialized]
        protected List<NoticeMessageUI> messages = new(8);
        ...
        public virtual void Update()
        {
            ...
            foreach (var message in messages)
            {
                ...
                if (message.showTime < 0.0f) message.Hide();
            }
        }
        ...
        public void AddMessage(string message, NoticeDuration duration, params object[] parameters)
        {
            AddMessage(string.Empty, message, duration, parameters);
        }

        public void AddMessage(string title, string message, NoticeDuration duration, params object[] parameters)
        {
        ...
        public virtual void AddMessage(InventoryNoticeMessage message)
        {
            ...
            var scrollbarAtBottom = false;
            if (scrollRect != null && scrollRect.verticalScrollbar != null &&
                scrollRect.verticalScrollbar.value < 0.05f)
            ...
            {
                StartCoroutine(DestroyAfter(messages[0],
                    messages[0].hideAnimation != null ? messages[0].hideAnimation.length : 0));
                messages[0].Hide();
                messages.RemoveAt(0);
            }
        ...
        ///     This is because someone might want to implement their own system and just use the event as a link to connect the 2
        ///     systems.
        /// </summary>
        ...
        public delegate void NewMessage(InventoryNoticeMessage message, params object[] parameters);
