...
namespace Devdog.InventoryPro
{
    ...
    public class InfoBoxUI : MonoBehaviour
    {
        ...
        /// </summary>
        public bool showOutOfRangeLootables;
        ...
        public bool overrideUsageRequirementString;
        ...
        protected virtual void Awake()
        {
            ...
            poolRows = new ComponentPool<InfoBoxRowUI>(infoBoxRowPrefab);
        ...
        protected virtual void Update()
        {
            ...
            else
            {
                ...
                {
                    if (showWhenHoveringLootableObject) HandleItemTrigger(TriggerUtility.mouseOnTrigger);
                }
                else
                {
        ...
        protected virtual void HandleItemTrigger(TriggerBase trigger)
        {
            if (trigger != null)
            {
                if (trigger.inRange == false && showOutOfRangeLootables == false) return;
        ...
        protected virtual void Repaint(InventoryItemBase item, LinkedList<ItemInfoRow[]> itemInfo)
        {
            ...
            if (showItemInfo) DrawItemInfo(item, itemInfo);

            // have we got usagerequirements?
            if (showUsageRequirements && item.usageRequirement.Length > 0) DrawUsageRequirements(item);
