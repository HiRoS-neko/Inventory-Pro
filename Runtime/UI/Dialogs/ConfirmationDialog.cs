...
{
    public class ConfirmationDialog : InventoryUIDialogBase
    {
        ...
        public virtual void ShowDialog(Transform caller, string title, string description,
            InventoryUIDialogCallback yesCallback, InventoryUIDialogCallback noCallback)
        {
        ...
        /// <param name="yesCallback"></param>
        /// <param name="noCallback"></param>
        public virtual void ShowDialog(Transform caller, string title, string description, InventoryItemBase item,
            InventoryUIDialogCallback yesCallback, InventoryUIDialogCallback noCallback)
        {
            ShowDialog(caller, string.Format(title, item.name, item.description),
                string.Format(description, item.name, item.description), yesCallback, noCallback);
        }
    }
}