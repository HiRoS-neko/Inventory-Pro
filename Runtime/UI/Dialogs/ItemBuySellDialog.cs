...
namespace Devdog.InventoryPro.Dialogs
{
    ...
    public class ItemBuySellDialog : ItemIntValDialog
    {
        public Text price;
        ...
        public override void ShowDialog(Transform caller, string title, string description, int minValue, int maxValue,
        ...
        protected override void OnAmountValueChanged(string amountString)
        {
            ...
            var amount = GetInputValue(); // Let's trust Unity on this...
            ...
            if (currencyDef != null) SetPriceColor(finalPrice, currencyDef);
        }
        ...
        private void GetTransactionInfo(int amount, out string formattedText, out float finalPrice,
            out CurrencyDefinition finalCurrency)
        {
        ...
        public virtual void ShowDialog(Transform caller, string title, string description, int minValue, int maxValue,
            InventoryItemBase item, ItemBuySellDialogAction action, VendorTrigger vendor,
            IntValDialogCallback yesCallback, IntValDialogCallback noCallback)
        {
