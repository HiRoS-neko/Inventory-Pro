...
namespace Devdog.InventoryPro.Dialogs
{
    ...
    public class IntValDialog : InventoryUIDialogBase
    {
        [Header("UI int val")]
        ...
        public UIShowValue valueVisualizer = new();
        public AmountFieldControls amountControl;

        private bool _axisFired;
        ...
        public override void Update()
        {
            ...
            if (Input.GetAxisRaw(plusMinusAxis) == 0.0f) _axisFired = false;
        }
        ...
        ///     Show this dialog.
        ///     <b>
        ///         Don't forget to call dialog.Hide(); when you want to hide it, this is not done auto. just in case you want to
        ///         animate it instead of hide it.
        ///     </b>
        /// </summary>
        ...
        public virtual void ShowDialog(Transform caller, string title, string description, int min, int max,
            IntValDialogCallback yesCallback, IntValDialogCallback noCallback)
        {
            ...
            if (amountControl != null) amountControl.Set(min, max);
        ...
        /// <param name="maxValue">The max value allowed to be selected.</param>
        /// <param name="item">
        ///     You can add an item, if you're confirming something for that item. This allows you to use {0} for the title and {1}
        ///     for the description inside the title and description variables of the dialog.
        ///     An example:
        ...
        /// <param name="yesCallback"></param>
        /// <param name="noCallback"></param>
        public virtual void ShowDialog(Transform caller, string title, string description, int minValue, int maxValue,
            InventoryItemBase item, IntValDialogCallback yesCallback, IntValDialogCallback noCallback)
        {
            ShowDialog(caller, string.Format(title, item.name, item.description),
                string.Format(description, item.name, item.description), minValue, maxValue, yesCallback, noCallback);
        }
