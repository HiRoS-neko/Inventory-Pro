...
namespace Devdog.InventoryPro
{
    ...
    public class ItemCollectionSlotUIKeyTrigger : ItemCollectionSlotUI
    {
        public Text keyCombinationText;

        public string keyCombination
        {
            get => keyCombinationText != null ? keyCombinationText.text : "";
            set
            {
        ...
        public override void TriggerUse()
        {
            ...
            if (item != null)
            {
                var i = item;
                var used = i.Use();
                if (used >= 0 && i.currentStackSize <= 0) item = null;
        ...
        public override void Repaint()
        {
            ...
            if (keyCombinationText != null) keyCombinationText.text = keyCombination;
        }
    }
}