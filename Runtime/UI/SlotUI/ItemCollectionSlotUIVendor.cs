...
namespace Devdog.InventoryPro
{
    ...
    public class ItemCollectionSlotUIVendor : ItemCollectionSlotUI
    {
        ...
        public VendorUI vendor
        {
            get
            {
                ...
                {
                    var vendors =
                        GetComponentsInParent<VendorUI>(
                            true); // GetComponentInParent (single), doesn't handle in-active objects.
                    if (vendors.Length > 0)
                        _vendor = vendors[0];
                }
                ...
                if (_vendor == null)
                    Debug.LogWarning(
                        "No VendorUI found in parent of InventoryUIItemWrapperVendor! You can only use the *WrapperVendor in a vendor collection.",
                        transform);
        ...
        public bool isInBuyBack => gameObject.GetComponentsInParent<VendorUIBuyBack>(true).Length > 0;
        ...
        public override void TriggerContextMenu()
        {
            ...
            contextMenu.AddMenuOption("Buy", item, i => { vendor.currentVendor.BuyItemFromVendor(i, isInBuyBack); });
