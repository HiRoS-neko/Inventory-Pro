...
namespace Devdog.InventoryPro.UI
{
    ...
    public class ItemCollectionWeightUI : MonoBehaviour
    {
        ...
        protected virtual void Awake()
        {
            ...
            if (window != null) window.OnShow += Repaint;
        }
        ...
        {
            if (weightText != null)
                weightText.text = string.Format(format, Math.Round(collection.GetWeight(), roundAmount),
                    collection.restrictMaxWeight);
        }
    }
}