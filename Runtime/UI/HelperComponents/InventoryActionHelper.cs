...
namespace Devdog.InventoryPro.UI
{
    ...
    public class InventoryActionHelper : MonoBehaviour
    {
        ...
        private ItemCollectionSlotUIBase markedSlot
        {
            ...
            set
            {
                ...
                {
                    var button = _markedSlot.gameObject.GetComponent<Button>();
        ...
        {
            if (canUseSlot)
                InventoryUIUtility.currentlySelectedSlot.TriggerUnstack(InventoryUIUtility.currentlySelectedSlot
                    .itemCollection);
        ...
        public void MarkCurrentlySelectedSlot()
        {
            if (canUseSlot)
            {
                ...
                var button = InventoryUIUtility.currentlySelectedSlot.gameObject.GetComponent<Button>();
                if (button != null && button.targetGraphic != null)
                {
        ...
        private void ClearMarkedSlot()
        {
            ...
            var button = markedSlot.gameObject.GetComponent<Button>();
            if (button != null && button.targetGraphic != null)
            {
                var image = button.targetGraphic as Image;
                if (image != null)
